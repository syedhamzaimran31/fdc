...
export function Thesis() {
  return (
    <section aria-labelledby="thesis-heading">
      ...
      <h1
        className="font-display mt-4 text-[clamp(2.375rem,6.2vw,4.25rem)] leading-[0.98] font-bold
      ...
      <p className="text-muted-foreground mt-6 max-w-[68ch] text-[1.1875rem] text-pretty">
